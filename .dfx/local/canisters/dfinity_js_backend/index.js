...
import { idlFactory } from './dfinity_js_backend.did.js';
export { idlFactory } from './dfinity_js_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.DFINITY_JS_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./dfinity_js_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the dfinity_js_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./dfinity_js_backend.did.js")._SERVICE>}
 */
export const dfinity_js_backend = createActor(canisterId);
